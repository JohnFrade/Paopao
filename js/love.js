	...
	function t(t, n, r) {
		...
		return function(e) {
			...
			var n = a(e),
				...
				o = w(e),
				u = v(e);
            r.rotate(-5 * Math.PI / 180),r.translate(o, u), r.scale(n, n), r.globalAlpha = g(e), r.drawImage(t, -t.width / 2, -t.height / 2, t.width, t.height), r.restore()
		}
	}
	var e = function(t) {
			var e = t,
		...
		o = function() {
			...
			return r(o, [{
				key: "bubble",
				value: function(n) {
					var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e.uniformDiscrete(1200, 2000),
