...
! function (e, t) {
	...
	return function (e) {
		...
		function a() {
			function e() {
				(0, s.default)(a.container).append(v), s.default.getStyle(v[0], "transform"), v.find(".weui-mask").addClass("weui-animate-fade-in"), v.find(".weui-picker").addClass("weui-animate-slide-up")
			}

			function t(e) {
				t = s.default.noop, v.find(".weui-mask").addClass("weui-animate-fade-out"), v.find(".weui-picker").addClass("weui-animate-slide-down").on("animationend webkitAnimationEnd", function () {
					v.remove(), w = !1, a.onClose(), e && e()
				})
			}
			...
			function i(e, t) {
				...
				v.find(".weui-picker__group").eq(t).scroll({
					...
					onChange: function (e, n) {
						...
						else if (e.children && e.children.length > 0) v.find(".weui-picker__group").eq(t + 1).show(), !c && i(e.children, t + 1);
						else {
							var o = v.find(".weui-picker__group");
							o.forEach(function (e, n) {
								n > t && (0, s.default)(e).hide()
							}), d.splice(t + 1), a.onChange(d)
						}
					},
			...
			b[a.id] = b[a.id] || [];
			for (var d = [], h = b[a.id], v = (0, s.default)(s.default.render(m.default, a)), y = o.depth || (c ? u.length : p.depthOf(u[0])), _ = "", k = y; k--;) _ += g.default;
			return v.find(".weui-picker__bd").html(_), e(), c ? u.forEach(function (e, t) {
				i(e, t)
		...
		function u(e) {
			...
			var n = function (e, t, n) {
				...
				i = [],
				o = d.default.parse(t.cron, t.start, t.end),
				r = void 0;
			do {
				r = o.next();
				var u = r.value.getFullYear(),
					f = r.value.getMonth() + 1,
					c = r.value.getDate(),
					l = n(i, "value", u);
				l || (l = {
					label: u + "年",
		...
		var a = n(3),
			...
			f = n(4),
			c = i(f);
		o.call(c.default, navigator.userAgent), (0, u.default)(c.default.fn, {
			append: function (e) {
		...
		! function (n, r) {
			r = function (e, t, n) {
				function i(o, r, a) {
					return a = Object.create(i.fn), o && a.push.apply(a, o[t] ? [o] : "" + o === o ? /</.test(o) ? ((r = e.createElement(r || t)).innerHTML = o, r.children) : r ? (r = i(r)[0]) ? r[n](o) : a : e[n](o) : "function" == typeof o ? e.readyState[7] ? o() : e[t]("DOMContentLoaded", o) : o), a
				}
		...
		function i(e, t) {
			...
			for (var u = e.split(","), f = 0, c = u.length; f < c; f++) {
				var s = u[f];
				s.match(a) && s.replace(a, function (e, t, a, u) {
					u = parseInt(u) || 1, t = Math.min(Math.max(n, ~~Math.abs(t)), i), a = a ? Math.min(i, ~~Math.abs(a)) : t, r = t;
					do o.push(r), r += u; while (r <= a)
				})
			}
			return o
		}
		...
		a.default.fn.scroll = function (e) {
			...
			function n(e) {
				g = e;
				var t = g - y;
				u(m, 0), f(m, b + t), w = +new Date, _.push({
					time: w,
					y: g
				}), _.length > 40 && _.shift()
			}
			...
			function i(e) {
				if (y) {
					...
					if (g = e, t - w > 100) E(Math.abs(g - y) > 10 ? g - y : n - g);
						...
						for (var i = _.length - 1, o = i, r = i; r > 0 && w - _[r].time < 100; r--) o = r;
						if (o !== i) {
							var a = _[i],
								u = _[o],
								f = a.time - u.time,
			...
			if (null !== h.temp && h.temp < h.items.length) {
				var j = h.temp;
				h.onChange.call(this, h.items[j], j), b = (h.offset - j) * h.rowHeight
			} else {
				var x = c(h.items);
				h.onChange.call(this, h.items[x], x), b = s(h.offset, h.rowHeight, h.items)
			}
			f(m, b);
			var E = function (e) {
				b += e, b = Math.round(b / h.rowHeight) * h.rowHeight;
				...
				b = (h.offset - i) * h.rowHeight, u(m, .3), f(m, b), h.onChange.call(r, h.items[i], i)
			};
